...
if (isset($_GET['status'])) {
   ...
   switch ($_GET['status']) {
      ...
      case 'maior':
         ...
         $text = 'Quantidade maior que o informado !!!';
         break;
...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      <td style="text-transform:uppercase"><h4><span class="badge badge-pill badge-danger"> <i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp;' . $item->baias . '&nbsp; </span></h4> </td>
                      <td style="text-transform:uppercase;font-size:20px;text-align:center">
                      
                      <input type="text" size="1" class="form-control centro qtd-40" name="val[' . $item->id  . ']" value="' . $item->qtd . '" />
         ...
         <div class="col-12">
            ...
            <div class="card back-black">
               <div class="card-header">
                  <button accesskey="q" title="ALT+K" type="submit" class="btn btn-warning" data-toggle="modal" data-target="#modal-default"> <i class="fas fa-plus"></i> &nbsp; Novo</button>
                  <button accesskey="r" title="ALT+R" style="margin-left: 10px;" type="submit" class="btn btn-success float-right" data-toggle="modal" data-target="#modal-data"> <i class="fas fa-print"></i> &nbsp; IMPRIMIR RELATÓRIOS</button>
                  <button accesskey="e" title="ALT+E" type="submit" class="btn btn-danger float-right" data-toggle="modal" data-target="#modal-data2"><i class="fas fa-chart-bar"></i> &nbsp; IMPRIMIR ESTATÍSTICA</button>
               </div>
               <!-- /.card-header -->
               ...
               <div class="row">
                  ...
                  <div class="col-6">
                     ...
                     <div class="form-group">
                        ...
                        <input style="text-transform: uppercase;" type="text" class="form-control" name="qtd" id="qtd2" required autofocus>
                     </div>
                  ...
                  <div class="col-4">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" name="servicos" id="servicos"></select>
                     </div>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-6">
                     ...
                     <div class="form-group">
                        ...
                        <input value="" type="datetime-local" class="form-control" name="data" id="data" required>
                     </div>
                  </div>
                  ...
                  <div class="col-3">
                     ...
                     <div class="form-group">
                        <label>Cliente</label>
                        <select class="form-control select" style="width: 100%;" name="clientes_id" id="clientes_id" required>
                           <option value=""> Selecione um cliente</option>
                           <?php
