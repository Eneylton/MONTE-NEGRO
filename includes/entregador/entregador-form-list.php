...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      <td style="text-align:center">  <button class="btn btn-outline-primary btn-sm" onclick="listarSetores(' . $item->id . ')">SETORES</button></td>
                      <td style="text-align:center">  <button class="btn btn-outline-success btn-sm" onclick="listarServicos(' . $item->id . ')">SERVIÇOS</button></td>
                      <td style="text-transform:uppercase"> <h5><span class="badge badge-pill badge-danger">' . $item->veiculo . '</span></h5> </td>
                      ...
                      &nbsp;
                       ...
                       <button type="button" class="btn btn-secondary btn-sm"> <i class="far fa-trash-alt"></i> &nbsp; Excluir</button>
                       </a>
            ...
            <div class="modal-body">
               ...
               <div class="row">
                  ...
                  <div class="col-4">
                     <div class="form-group">
                        <label>CPF</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="cpf" id="registro">
                     </div>
                  </div>
                  ...
                  <div class="col-4">
                     <div class="form-group">
                        ...
                        <input style="text-transform:uppercase" type="text" class="form-control" name="telefone" id="cel">
                     </div>
                  </div>
                  <div class="col-4">
                     <div class="form-group">
                  ...
                  <div class="col-3">
                     <div class="form-group">
                        ...
                        <input style="text-transform:uppercase" type="text" class="form-control " name="valor_boleto" id="valor1">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Valor Cartão</label>
                        <input style="text-transform:uppercase" type="text" class="form-control " name="valor_cartao" id="valor2">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Valor Entrega Pequeno</label>
                        <input style="text-transform:uppercase" type="text" class="form-control " name="valor_pequeno" id="valor3">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Valor entrega grande</label>
                        <input style="text-transform:uppercase" type="text" class="form-control " name="valor_grande" id="valor4">
                     </div>
                  </div>
                  <div class="col-4">
                     <div class="form-group">
                  ...
                  <div class="col-4">
                     <div class="form-group">
                        ...
                        <input value="<?php
                                       ...
                                       echo date('Y-m-d\TH:i:s', time()); ?>" type="datetime-local" class="form-control" name="admissao" id="admissao" required>
                     </div>
                  </div>
                  <div class="col-4">
                     <div class="form-group">
                        ...
                        <input value="<?php
                                       date_default_timezone_set('America/Sao_Paulo');
                                       echo date('Y-m-d\TH:i:s', time()); ?>" type="datetime-local" class="form-control" name="recisao" id="recisao" required>
                     </div>
                  </div>
                  <div class="col-4">
                     <div class="form-group">
