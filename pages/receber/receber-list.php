...
INNER JOIN
servicos AS s ON (r.servicos_id = s.id)','r.usuarios_id='.$usuario, 'r.id DESC', null);
...
<script>
    ...
    jQuery.fn.extend({
        CreateMultiCheckBox: function(options) {
            ...
            var detail = $("<div class='MultiCheckBoxDetail'><div class='MultiCheckBoxDetailHeader'><input type='checkbox' class='mulinput' value='-1982' /><div>SELECIONAR TODOS</div></div><div class='MultiCheckBoxDetailBody'></div></div>").insertAfter(divSel);
            detail.css({
            ...
            this.find("option").each(function() {
                ...
                multiCheckBoxDetailBody.append("<div class='cont'><div style='padding-right:7px'><input type='checkbox' class='mulinput' value='" + val + "' /></div><div>" + $(this).text() + "</div></div>");
            });
